 ...
 * @info: the info struct parameter and return
 * @estr: string with the appropriate error type
 * Return: 0 if the string contains no numbers,
 *        -1 in the event of an error
 */
...
/**
 * print_d - function outputs an integer (decimal) number (base 10)
 * @input: input
...
/**
 * convert_number - translator function, an imitation of itoa
 * @num: the number
 * @base: the base
 ...
 * @buf: Where to find the string to change
 *
 * Return: 0
 */
