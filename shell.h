...
/**
 *struct passinfo - maintains a standard prototype for the function pointer
 *	structure by including pseudo-arguments to pass into a function.
 *@arg: a string with arguments that was produced by getline
 *@argv: a collection of strings produced by arg
 *@path: a route in strings for the active command
 *@argc: the number of disputes
 *@line_count: the number of errors
 *@err_num: the exit()s error code
 *@linecount_flag: if this input line is counted
 *@fname: a program's filename
 *@env: linked list local environment copy
 ...
 *@readfd: the file directory to read line input from
 *@histcount: the line count of history
 */
 ...
 *@type: the integrated command symbol
 *@func: function
 */
